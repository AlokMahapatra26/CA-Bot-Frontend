...
export default function DeleteButton({ filingId, clientId }: DeleteButtonProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        disabled={isDeleting}
        className={`inline-flex items-center justify-center p-1 border transition-all rounded-md ${
          isOpen 
        ...
        <div className="absolute right-0 mt-1 w-52 bg-white border border-slate-200 shadow-lg rounded-lg z-50">
          <div className="py-1 flex flex-col">
            <button
              ...
              className="px-3 py-2 text-left text-xs font-semibold text-slate-700 hover:bg-slate-50 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={isDeleting}
              className="px-3 py-2 text-left text-xs font-semibold text-red-600 hover:bg-red-50 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
